  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:residentialArea:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:residentialArea:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:residentialArea:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:residentialArea:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:residentialArea:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:residentialArea:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:residentialArea:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:residentialArea:column-filter']"
        ...
        <div
          v-permission="['fireprot:residentialArea:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('population')"
            prop="population"
            label="人口"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('acreage')"
            prop="acreage"
            label="面积"
            min-width="120"
            sortable="custom"
...
import ResidentialAreaEditDialog from "./editDialogs/residentialAreaEditDialog.vue";
import ResidentialAreaEdit from "./edits/residentialAreaEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_residential_area").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "名称", parameter: "name" },
        { name: "人口", parameter: "population" },
        { name: "面积", parameter: "acreage" },
        { name: "负责人", parameter: "responsible" },
        { name: "负责人电话", parameter: "responsibleTel" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      residentialAreaApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["residentialAreaEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["residentialAreaEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      residentialAreaApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          residentialAreaApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
