  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['forestry:roadData:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['forestry:roadData:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['forestry:roadData:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['forestry:roadData:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['forestry:roadData:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['forestry:roadData:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['forestry:roadData:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['forestry:roadData:column-filter']"
        ...
        <div
          v-permission="['forestry:roadData:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <dictionary-text code="road_data_type" :value="scope.row.type" />
            </template>
          </el-table-column>
...
import { roadDataApi } from "@/api/forestry/roadData";
import RoadDataEditDialog from "./editDialogs/roadDataEditDialog.vue";
import RoadDataEdit from "./edits/roadDataEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("bgd_road_data").showColumn,
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      roadDataApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["roadDataEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["roadDataEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      roadDataApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          roadDataApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
