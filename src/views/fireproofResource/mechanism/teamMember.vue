  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:teamMember:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:teamMember:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:teamMember:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:teamMember:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:teamMember:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:teamMember:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:teamMember:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:teamMember:column-filter']"
        ...
        <!-- <div
          v-permission="['fireprot:teamMember:layout']"
          style="display: flex; align-items: center"
...
import TeamMemberEditDialog from "./editDialogs/teamMemberEditDialog.vue";
import TeamMemberEdit from "./edits/teamMemberEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_team_member").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "姓名", parameter: "name" },
        { name: "年龄", parameter: "age" },
        { name: "电话", parameter: "tel" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      teamMemberApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["teamMemberEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["teamMemberEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      teamMemberApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          teamMemberApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
