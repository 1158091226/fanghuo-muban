  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">队伍编号</div>
          <el-input
            v-model.trim="query.teamNum"
            style="flex: 1"
            placeholder="请输入队伍编号"
            class="filter-item"
            clearable
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:teamMgmt:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:teamMgmt:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:teamMgmt:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:teamMgmt:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:teamMgmt:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:teamMgmt:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:teamMgmt:column-filter']"
        ...
        <div
          v-permission="['fireprot:teamMgmt:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('teamNum')"
            prop="teamNum"
            label="队伍编号"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('numOfPeople')"
            prop="numOfPeople"
            label="队伍人数"
            min-width="120"
            sortable="custom"
...
import TeamMgmtEditDialog from "./editDialogs/teamMgmtEditDialog.vue";
import TeamMgmtEdit from "./edits/teamMgmtEdit.vue";

import ReserveSupplies from "@/views/fireproofResource/fireproofingFacility/supplies.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_team_mgmt").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "名称", parameter: "name" },
        { name: "队伍编号", parameter: "teamNum" },
        { name: "中文地址", parameter: "address" },
        { name: "负责人", parameter: "responsible" },
        { name: "联系电话", parameter: "responsibleTel" },
        { name: "队伍成立时间", parameter: "establishmentTime" },
        { name: "队伍人数", parameter: "numOfPeople" },
        { name: "队伍类型", parameter: "type" },
      ],
    };
  },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      teamMgmtApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["teamMgmtEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["teamMgmtEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      teamMgmtApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          teamMgmtApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
