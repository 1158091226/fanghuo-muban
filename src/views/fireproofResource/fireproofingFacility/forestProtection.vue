  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">建设日期</div>
          <el-input
            v-model.trim="query.buildTime"
            style="flex: 1"
            placeholder="请输入建设日期"
            class="filter-item"
            clearable
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div
              v-permission="['fireprot:forestProtection:more']"
              class="text1"
            >
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:forestProtection:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:forestProtection:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:forestProtection:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:forestProtection:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:forestProtection:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:forestProtection:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:forestProtection:column-filter']"
        ...
        <div
          v-permission="['fireprot:forestProtection:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      <!-- 这是属性框 -->
      <ForestProtectionEdit
        v-if="isScreenCutting"
        ref="forestProtectionEdit"
...
import ForestProtectionEditDialog from "./editDialogs/forestProtectionEditDialog.vue";
import ForestProtectionEdit from "./edits/forestProtectionEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_forest_protection").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "建筑面积(平方米)", parameter: "buildArea" },
        { name: "建设日期", parameter: "buildTime" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      forestProtectionApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["forestProtectionEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["forestProtectionEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      forestProtectionApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          forestProtectionApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
