  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.checkArea"
            style="width: 100%"
            placeholder="请输入检查区域"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.checkArea }}</div>
        </el-form-item>
        <el-form-item
          label="负责人"
          :class="[
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:checkpoint:update']"
          type="primary"
          class="right-btn"
  ...
  methods: {
    ...
    detailsSaveClick() {
      this.$refs["formDetails"].validate((valid) => {
        if (valid) {
          ...
          checkpointApi("update", "post", data)
            .then((res) => {
              this.$message({
                type: "success",
                message: "修改成功",
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        checkpointApi("detail", "get", { id: queryData.id })
          .then((res) => {
            let data = {};
