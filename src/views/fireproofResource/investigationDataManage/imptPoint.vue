  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          ...
          <el-input
            v-model.trim="query.fireSourcePointName"
            style="flex: 1"
            placeholder="请输入名称"
            class="filter-item"
            clearable
        ...
        <div class="screen-box-item">
          ...
          <dictionary-select
            v-model.trim="query.fireSourcePointType"
        ...
        <div class="screen-box-item">
          <div class="item-text">级别</div>
          <dictionary-select
            v-model.trim="query.level"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:imptPoint:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:imptPoint:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:imptPoint:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:imptPoint:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:imptPoint:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:imptPoint:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:imptPoint:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:imptPoint:column-filter']"
        ...
        <div
          v-permission="['fireprot:imptPoint:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('fireSourcePointName')"
          ...
          <el-table-column
            v-if="checkedTh.includes('fireSourcePointType')"
          ...
          >
            <template slot-scope="scope">
              <dictionary-text
                code="fire_source_point_type"
                :value="scope.row.fireSourcePointType"
              />
            </template>
          </el-table-column>

          <el-table-column
            v-if="checkedTh.includes('level')"
            prop="level"
            label="级别"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('numberOfFirePoints')"
...
import ImptPointEditDialog from "./editDialogs/imptPointEditDialog.vue";
import ImptPointEdit from "./edits/imptPointEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_impt_point").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "名称", parameter: "fireSourcePointName" },
        { name: "类型", parameter: "fireSourcePointType" },
        { name: "级别", parameter: "level" },
        { name: "火源点数量", parameter: "numberOfFirePoints" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      imptPointApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["imptPointEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["imptPointEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      imptPointApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          imptPointApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
