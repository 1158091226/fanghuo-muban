  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['forestry:lakeData:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['forestry:lakeData:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['forestry:lakeData:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['forestry:lakeData:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['forestry:lakeData:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['forestry:lakeData:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['forestry:lakeData:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['forestry:lakeData:column-filter']"
        ...
        <div
          v-permission="['forestry:lakeData:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <dictionary-text code="lake_data_type" :value="scope.row.type" />
            </template>
          </el-table-column>
...
import { lakeDataApi } from "@/api/forestry/lakeData";
import LakeDataEditDialog from "./editDialogs/lakeDataEditDialog.vue";
import LakeDataEdit from "./edits/lakeDataEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("bgd_lake_data").showColumn,
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      lakeDataApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["lakeDataEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["lakeDataEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      lakeDataApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          lakeDataApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
