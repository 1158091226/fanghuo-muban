  ...
  <div v-loading="requestLoading" class="app-list-page">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        <!-- <div class="screen-box-item">
          <div class="item-text">图层详细名1</div>
          <el-input
            v-model.trim="query.layerDetailName"
            style="flex: 1"
            placeholder="请输入图层详细名"
            class="filter-item"
            clearable
          />
        </div> -->
        ...
        <div class="screen-box-item">
          ...
          <el-select
            ...
            class="filter-item"
          >
            <el-option value="local">local</el-option>
      ...
      <div class="screen-box-button">
        <!-- <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['layers:layersDescribe:more']" class="text1">
              更多
        ...
        <el-button
          v-permission="['layers:layersDescribe:query']"
          type="primary"
          class="btn"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <!-- <el-button
          v-permission="['layers:layersDescribe:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['layers:layersDescribe:delete']"
          class="btn2"
          type="danger"
        ...
        > -->
        <!-- <el-button
          v-permission="['layers:layersDescribe:import']"
          class="btn3"
          icon="el-icon-importnew"
          plain
        >导入</el-button>
        <el-button
          v-permission="['layers:layersDescribe:export']"
          class="btn4"
          icon="el-icon-exportnew"
          plain
        >导出</el-button>
        <el-button
          v-permission="['layers:layersDescribe:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
        >一张图</el-button> -->
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['layers:layersDescribe:column-filter']"
        ...
        <!-- <div
          v-permission="['layers:layersDescribe:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('ogriginalName')"
            prop="ogriginalName"
            label="文件原名"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('repoType')"
            prop="repoType"
            label="仓库类型"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('suffixType')"
            prop="suffixType"
            label="文件类型"
            min-width="120"
            show-overflow-tooltip
...
import FilesInformationEditDialog from "./editDialogs/filesInformationEditDialog.vue";

const listItemDefault = {
  id: undefined,
  layerDetailName: undefined,
  describe: undefined,
  timing: undefined,
  source: undefined,
};
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: ["ogriginalName", "path", "repoType", "suffixType", "size"],
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "文件原名", parameter: "ogriginalName" },
        { name: "文件相对路径", parameter: "path" },
        { name: "仓库类型", parameter: "repoType" },
        { name: "文件类型", parameter: "suffixType" },
        { name: "文件大小", parameter: "size" },
      ],
    };
  },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      filesInformation("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["layersDescribeEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["layersDescribeEdit"].initDetails();
        });
      }
    },
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          filesInformation("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
