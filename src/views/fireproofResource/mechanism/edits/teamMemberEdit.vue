  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.age"
            style="width: 100%"
            placeholder="请输入年龄"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.age }}</div>
        </el-form-item>
        <el-form-item
          label="电话"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.tel"
            style="width: 100%"
            placeholder="请输入电话"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.tel }}</div>
        </el-form-item>
        <el-form-item
          label="职位"
          :class="[
        ...
        >
          <el-input
            ...
            clearable
          />
          <div v-else>{{ formDetails.position }}</div>
        </el-form-item>
        <el-form-item
          label="专业技术水平"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.technicalLevel"
            style="width: 100%"
            placeholder="请输入专业技术水平"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.technicalLevel }}</div>
        </el-form-item>
        <el-form-item
          label="特长说明"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.speciality"
            style="width: 100%"
            placeholder="请输入特长说明"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.speciality }}</div>
        </el-form-item>
        <el-form-item
          label="图片"
          :class="[
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:teamMember:update']"
          type="primary"
          class="right-btn"
