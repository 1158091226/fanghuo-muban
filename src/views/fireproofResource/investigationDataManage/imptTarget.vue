  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          ...
          <dictionary-select
            v-model.trim="query.protLevel"
            type="protected_object_level"
            :show-code="false"
            :placeholder="'请选择'"
            class="filter-item"
            style="flex: 1"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:imptTarget:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:imptTarget:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:imptTarget:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:imptTarget:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:imptTarget:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:imptTarget:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:imptTarget:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:imptTarget:column-filter']"
        ...
        <div
          v-permission="['fireprot:imptTarget:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('protLevel')"
            prop="protLevel"
            label="保护等级"
            min-width="120"
            sortable="custom"
          ...
          >
            <template slot-scope="scope">
              <dictionary-text
                code="protected_object_level"
                :value="scope.row.protLevel"
              />
            </template>
          </el-table-column>
          ...
          <el-table-column
            v-if="checkedTh.includes('photoUniqueName')"
...
import ImptTargetEditDialog from "./editDialogs/imptTargetEditDialog.vue";
import ImptTargetEdit from "./edits/imptTargetEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_impt_target").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "保护等级", parameter: "protLevel" },
        { name: "负责人", parameter: "responsible" },
        { name: "联系电话", parameter: "responsibleTel" },
        { name: "图片", parameter: "photoUniqueName" },
        { name: "概括", parameter: "describe" },
      ],
    };
  },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      imptTargetApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["imptTargetEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["imptTargetEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      imptTargetApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          imptTargetApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
