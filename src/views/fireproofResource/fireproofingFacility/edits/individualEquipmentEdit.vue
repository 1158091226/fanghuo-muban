  ...
  <div class="list-details">
      ...
      >
        ...
        >
          <el-input
            ...
            clearable
          />
          <div v-else>{{ formDetails.unit }}</div>
        </el-form-item>
        <el-form-item
          label="存放位置"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.deviceStorageLocation"
            style="width: 100%"
            placeholder="请输入存放位置"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.deviceStorageLocation }}</div>
        </el-form-item>
        <el-form-item
          label="设备详情"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.equipmentDetails"
            type="textarea"
            placeholder="请输入设备详情"
          />
          <div v-else>{{ formDetails.equipmentDetails }}</div>
        </el-form-item>
        ...
        >
          <el-input
            ...
            clearable
          />
          <div v-else>{{ formDetails.userName }}</div>
        </el-form-item>
        <el-form-item
          label="使用人员电话"
          :class="[
        ...
        >
          ...
          <div v-else>
            <div v-if="isShowuserTel">
              {{ isShowSecretFunction(formDetails.userTel, 3, 7)
              }}<el-button
                size="mini"
                class="ml-10"
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:individualEquipment:update']"
          type="primary"
          class="right-btn"
