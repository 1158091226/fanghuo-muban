  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.producer"
            style="width: 100%"
            placeholder="请输入制作单位"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.producer }}</div>
        </el-form-item>
        <el-form-item
          label="制作时间"
          :class="[
        ...
        >
          <el-date-picker
            v-if="detailsType != '详情'"
            v-model="formDetails.productionTime"
            type="date"
            placeholder="请选择制作时间"
            style="width: 100%"
            value-format="yyyy-MM-dd"
          />
          <div v-else>{{ formDetails.productionTime }}</div>
        </el-form-item>
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:billboard:update']"
          type="primary"
          class="right-btn"
  ...
  methods: {
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        billboardApi("detail", "get", { id: queryData.id })
          .then((res) => {
            let data = {};
