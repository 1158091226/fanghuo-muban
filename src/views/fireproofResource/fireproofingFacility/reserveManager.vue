  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">职位</div>
          <el-input
            v-model.trim="query.position"
            style="flex: 1"
            placeholder="请输入职位"
            class="filter-item"
            clearable
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:reserveManager:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:reserveManager:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:reserveManager:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:reserveManager:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:reserveManager:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:reserveManager:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:reserveManager:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:reserveManager:column-filter']"
        ...
        <!-- <div
          v-permission="['fireprot:reserveManager:layout']"
          style="display: flex; align-items: center"
    ...
    >
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('position')"
            prop="position"
            label="职位"
            min-width="120"
            sortable="custom"
...
import ReserveManagerEditDialog from "./editDialogs/reserveManagerEditDialog.vue";
import ReserveManagerEdit from "./edits/reserveManagerEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_reserve_manager").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "物资储备库关联id", parameter: "reserveId" },
        { name: "姓名", parameter: "name" },
        { name: "联系电话", parameter: "tel" },
        { name: "职位", parameter: "position" },
      ],
    };
  },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      reserveManagerApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["reserveManagerEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["reserveManagerEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      reserveManagerApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          reserveManagerApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
