  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <dictionary-select
            v-if="detailsType != '详情'"
            v-model.trim="formDetails.protLevel"
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:imptTarget:update']"
          type="primary"
          class="right-btn"
  ...
  methods: {
    ...
    detailsSaveClick() {
      this.$refs["formDetails"].validate((valid) => {
        if (valid) {
          ...
          imptTargetApi("update", "post", data)
            .then((res) => {
              this.$message({
                type: "success",
                message: "修改成功",
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        imptTargetApi("detail", "get", { id: queryData.id })
          .then((res) => {
            let data = {};
