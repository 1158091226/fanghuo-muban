...
const service = axios.create({
  baseURL: '/ceshi', // url = base url + request url
  ...
  (config) => {
    ...
    if (store.getters.token && getToken()) {
      ...
      config.headers['token'] =
        'eyJhbGciOiJIUzI1NiIsInppcCI6IkRFRiJ9.eJyrVsosLlayUsoozUzOz1fSUSouTQJyw12dgOyskkwg29jU1AzIyUwsUbIyNDcwNDQ1MjE0rQUA7xEPkg.hC0S-3PWI-oC6fEM5o-cbKvAlXhleoiClGZpS7qZqg0';
    }
    // 控制是否开启遮罩层
