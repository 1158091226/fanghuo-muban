  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.fireSourcePointName"
            style="width: 100%"
            placeholder="请输入名称"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.fireSourcePointName }}</div>
        </el-form-item>
        <el-form-item
          label="类型"
          :class="[
        ...
        >
          <dictionary-select
            v-if="detailsType != '详情'"
            v-model.trim="formDetails.fireSourcePointType"
          ...
          <div v-else>
            <dictionary-text
              ...
              :value="formDetails.fireSourcePointType"
            />
          </div>
        </el-form-item>
        ...
        >
          <dictionary-select
            v-if="detailsType != '详情'"
            v-model.trim="formDetails.level"
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.numberOfFirePoints"
            style="width: 100%"
            placeholder="请输入火源点数量"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.numberOfFirePoints }}</div>
        </el-form-item>
        <!--  是否是空间信息  -->
        <span />
        ...
        >
          <el-date-picker
            v-if="detailsType != '详情'"
            v-model="formDetails.monitorStartTime"
            type="date"
            placeholder="请选择重点监控开始时间"
            style="width: 100%"
            value-format="yyyy-MM-dd"
          />
          <div v-else>{{ formDetails.monitorStartTime }}</div>
        </el-form-item>
        ...
        >
          <el-date-picker
            v-if="detailsType != '详情'"
            v-model="formDetails.monitorEndTime"
            type="date"
            placeholder="请选择重点监控结束时间"
            style="width: 100%"
            value-format="yyyy-MM-dd"
          />
          <div v-else>{{ formDetails.monitorEndTime }}</div>
        </el-form-item>
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.manegeMeasures"
            style="width: 100%"
            placeholder="请输入管理措施"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.manegeMeasures }}</div>
        </el-form-item>
        <el-form-item
          label="负责人"
          :class="[
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:imptPoint:update']"
          type="primary"
          class="right-btn"
