  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:escapePoint:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:escapePoint:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:escapePoint:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:escapePoint:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:escapePoint:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:escapePoint:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:escapePoint:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:escapePoint:column-filter']"
        ...
        <div
          v-permission="['fireprot:escapePoint:layout']"
          style="display: flex; align-items: center"
...
import EscapePointEditDialog from "./editDialogs/escapePointEditDialog.vue";
import EscapePointEdit from "./edits/escapePointEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_escape_point").showColumn,
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      escapePointApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["escapePointEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["escapePointEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      escapePointApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          escapePointApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
