  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">中文名</div>
          <el-input
            v-model.trim="query.treeNameCn"
            style="flex: 1"
            placeholder="请输入中文名"
            class="filter-item"
            clearable
        ...
        <div class="screen-box-item">
          <div class="item-text">别名</div>
          <el-input
            v-model.trim="query.treeOtherName"
            style="flex: 1"
            placeholder="请输入别名"
            class="filter-item"
            clearable
        ...
        <div class="screen-box-item">
          <div class="item-text">管护人</div>
          <el-input
            v-model.trim="query.protectionPeople"
            style="flex: 1"
            placeholder="请输入管护人"
            class="filter-item"
            clearable
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div
              v-permission="['forestry:oldAndFamousTrees:more']"
              class="text1"
            >
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['forestry:oldAndFamousTrees:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['forestry:oldAndFamousTrees:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['forestry:oldAndFamousTrees:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['forestry:oldAndFamousTrees:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['forestry:oldAndFamousTrees:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['forestry:oldAndFamousTrees:column-filter']"
        ...
        <div
          v-permission="['forestry:oldAndFamousTrees:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('investigationNum')"
          ...
          <el-table-column
            v-if="checkedTh.includes('treeNameCn')"
            prop="treeNameCn"
            label="中文名"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('treeOtherName')"
            prop="treeOtherName"
            label="别名"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('treeNumber')"
            prop="treeNumber"
            label="编号"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('trueTreeAge')"
            prop="trueTreeAge"
            label="真实树龄"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('assessmentTreeAge')"
          ...
          <el-table-column
            v-if="checkedTh.includes('treeHeight')"
            prop="treeHeight"
            label="树高（米）"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('treeDhb')"
            prop="treeDhb"
            label="胸径"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('averageWidth')"
            prop="averageWidth"
            label="平均冠幅"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('eastWest')"
            prop="eastWest"
            label="东西冠幅"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('altitude')"
            prop="altitude"
            label="海拔"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('slopeAspect')"
            prop="slopeAspect"
            label="坡向"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('slopePosition')"
            prop="slopePosition"
            label="坡位"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('oldNum')"
            prop="oldNum"
            label="原挂牌号"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('protectionUnit')"
            prop="protectionUnit"
            label="管护单位"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('transplantingPerson')"
          ...
          <el-table-column
            v-if="checkedTh.includes('transplantingTime')"
          ...
          <el-table-column
            v-if="checkedTh.includes('growingPlace')"
            prop="growingPlace"
            label="生长场所"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('featureCode')"
            prop="featureCode"
            label="特征代码"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('treeLevel')"
            prop="treeLevel"
            label="古树等级"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('protectionPeople')"
            prop="protectionPeople"
            label="管护人"
            min-width="120"
            show-overflow-tooltip
          />
          ...
          <el-table-column
            v-if="checkedTh.includes('forestId')"
            prop="forestId"
            label="林地ID"
            min-width="120"
            sortable="custom"
      ...
      <!-- 这是属性框 -->
      <OldAndFamousTreesEdit
        v-if="isScreenCutting"
        ref="oldAndFamousTreesEdit"
...
import OldAndFamousTreesEditDialog from "./editDialogs/oldAndFamousTreesEditDialog.vue";
import OldAndFamousTreesEdit from "./edits/oldAndFamousTreesEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("forestry_old_and_famous_trees").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "调查号", parameter: "investigationNum" },
        { name: "中文名", parameter: "treeNameCn" },
        { name: "别名", parameter: "treeOtherName" },
        { name: "拉丁文", parameter: "latin" },
        { name: "编号", parameter: "treeNumber" },
        { name: "真实树龄", parameter: "trueTreeAge" },
        { name: "评估树龄", parameter: "assessmentTreeAge" },
        { name: "树高（米）", parameter: "treeHeight" },
        { name: "胸径", parameter: "treeDhb" },
        { name: "平均冠幅", parameter: "averageWidth" },
        { name: "东西冠幅", parameter: "eastWest" },
        { name: "南北冠幅", parameter: "south" },
        { name: "海拔", parameter: "altitude" },
        { name: "坡向", parameter: "slopeAspect" },
        { name: "坡度", parameter: "slope" },
        { name: "坡位", parameter: "slopePosition" },
        { name: "原挂牌号", parameter: "oldNum" },
        { name: "管护单位", parameter: "protectionUnit" },
        { name: "栽植人", parameter: "transplantingPerson" },
        { name: "栽植时间", parameter: "transplantingTime" },
        { name: "生长场所", parameter: "growingPlace" },
        { name: "特征代码", parameter: "featureCode" },
        { name: "古树等级", parameter: "treeLevel" },
        { name: "管护人", parameter: "protectionPeople" },
        { name: "林地ID", parameter: "forestId" },
      ],
    };
  },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      oldAndFamousTreesApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["oldAndFamousTreesEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["oldAndFamousTreesEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      oldAndFamousTreesApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          oldAndFamousTreesApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
