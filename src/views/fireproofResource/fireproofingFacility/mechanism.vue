  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">机构编码</div>
          <el-input
            v-model.trim="query.mechanismCode"
            style="flex: 1"
            placeholder="请输入机构编码"
            class="filter-item"
            clearable
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:mechanism:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:mechanism:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:mechanism:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:mechanism:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:mechanism:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:mechanism:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:mechanism:column-filter']"
        ...
        <div
          v-permission="['fireprot:mechanism:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('mechanismCode')"
            prop="mechanismCode"
            label="机构编码"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('unitLevel')"
            prop="unitLevel"
            label="单位级别"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('responsibilities')"
          ...
          <el-table-column
            v-if="checkedTh.includes('numOfPersonnel')"
            prop="numOfPersonnel"
            label="人员数量"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('avgAnnualInfraInvest')"
...
import MechanismEditDialog from "./editDialogs/mechanismEditDialog.vue";
import MechanismEdit from "./edits/mechanismEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_mechanism").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "机构编码", parameter: "mechanismCode" },
        { name: "单位级别", parameter: "unitLevel" },
        { name: "职责隶属", parameter: "responsibilities" },
        { name: "人员数量", parameter: "numOfPersonnel" },
        { name: "年均防火基建投资额(万元)", parameter: "avgAnnualInfraInvest" },
      ],
    };
  },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      mechanismApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["mechanismEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["mechanismEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      mechanismApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          mechanismApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
