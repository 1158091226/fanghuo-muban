  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          ...
          <dictionary-select
            v-model.trim="query.towerStatus"
            type="watchtower_state"
            :show-code="false"
            :placeholder="'请选择'"
            class="filter-item"
            style="flex: 1"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:watchtower:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:watchtower:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:watchtower:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:watchtower:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:watchtower:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:watchtower:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:watchtower:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:watchtower:column-filter']"
        ...
        <div
          v-permission="['fireprot:watchtower:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('buildAltitude')"
            prop="buildAltitude"
            label="建设海拔(米)"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('buildTime')"
            prop="buildTime"
            label="建设时间"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('towerHeigth')"
            prop="towerHeigth"
            label="塔体总高度(米)"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('towerStatus')"
            prop="towerStatus"
            label="状态"
            min-width="120"
            show-overflow-tooltip
          >
            <template slot-scope="scope">
              <dictionary-text
                code="watchtower_state"
                :value="scope.row.towerStatus"
              />
            </template>
          </el-table-column>
...
import WatchtowerEditDialog from "./editDialogs/watchtowerEditDialog.vue";
import WatchtowerEdit from "./edits/watchtowerEdit.vue";
...
const listItemDefault = {
  ...
  name: undefined,
  buildAltitude: undefined,
  buildTime: undefined,
  towerHeigth: undefined,
  observedArea: undefined,
  overallEffectiveLookoutArea: undefined,
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_watchtower").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "编号", parameter: "uuid" },
        { name: "空间位置", parameter: "boundaryLine" },
        { name: "名称", parameter: "name" },
        { name: "建设海拔(米)", parameter: "buildAltitude" },
        { name: "建设时间", parameter: "buildTime" },
        { name: "塔体总高度(米)", parameter: "towerHeigth" },
        { name: "状态", parameter: "towerStatus" },
        { name: "管护单位", parameter: "mgmtUnit" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      watchtowerApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["watchtowerEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["watchtowerEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      watchtowerApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          watchtowerApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
