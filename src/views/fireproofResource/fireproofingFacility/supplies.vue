  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <!-- <div class="screen-box-item">
          <div class="item-text">防火队伍关联id</div>
          <el-input
            v-model.trim="query.teamId"
            style="flex: 1"
        ...
        <div class="screen-box-item">
          <div class="item-text">物资储备库关联id</div>
          <el-input
            v-model.trim="query.reserveId"
            style="flex: 1"
        ...
        <div class="screen-box-item">
          <div class="item-text">类型名称</div>
          <dictionary-select
            v-model.trim="query.type"
        ...
        <div class="screen-box-item">
          <div class="item-text">状态</div>
          <dictionary-select
            v-model.trim="query.statusCode"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:supplies:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:supplies:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:supplies:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:supplies:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:supplies:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:supplies:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:supplies:column-filter']"
        ...
        <!-- <div
          v-permission="['fireprot:supplies:layout']"
          style="display: flex; align-items: center"
    ...
    >
      ...
      <div
        ...
        class="list-box"
        :style="{
          width: isScreenCutting ? listBoxWidth + 'px' : '100%',
          padding: 0,
        }"
      >
        <!-- 这是表格部分 -->
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('teamId')"
            prop="teamId"
            label="防火队伍关联id"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('reserveId')"
            prop="reserveId"
            label="物资储备库关联id"
            min-width="120"
            show-overflow-tooltip
          ...
          <!-- <el-table-column
            v-if="checkedTh.includes('amount')"
            prop="amount"
            label="数量"
            min-width="120"
            sortable="custom"
          ...
          >
            <template slot-scope="scope">
              <dictionary-text code="supplies_unit" :value="scope.row.unit" />
            </template>
          </el-table-column>

          <el-table-column
            v-if="checkedTh.includes('statusCode')"
            prop="statusCode"
            label="状态"
            min-width="120"
            sortable="custom"
...
import SuppliesEditDialog from "./editDialogs/suppliesEditDialog.vue";
import SuppliesEdit from "./edits/suppliesEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_supplies").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "物资名称", parameter: "name" },
        { name: "防火队伍关联id", parameter: "teamId" },
        { name: "物资储备库关联id", parameter: "reserveId" },
        { name: "类型名称", parameter: "type" },
        { name: "数量", parameter: "amount" },
        { name: "单位", parameter: "unit" },
        { name: "状态", parameter: "statusCode" },
      ],
    };
  },
  ...
  computed: {
    ...
    queryData() {
      ...
      data.reserveId = this.suppliesId;
      data.teamId = this.teamMgmtId;
      if (this.query.areaCode) {
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      suppliesApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["suppliesEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["suppliesEdit"].initDetails();
        });
      }
    },
    ...
    handleAddClick() {
      ...
      this.dialogSelectData = {
        reserveId: this.suppliesId,
        teamId: this.teamMgmtId,
      };
    },
    ...
    downExcelClick() {
      ...
      suppliesApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          suppliesApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
