  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">水源类型</div>
          <dictionary-select
            v-model.trim="query.waterSourceType"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div
              v-permission="['fireprot:helWaterIntaking:more']"
              class="text1"
            >
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:helWaterIntaking:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:helWaterIntaking:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:helWaterIntaking:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:helWaterIntaking:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:helWaterIntaking:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:helWaterIntaking:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:helWaterIntaking:column-filter']"
        ...
        <div
          v-permission="['fireprot:helWaterIntaking:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('waterSourceType')"
          ...
          >
            <template slot-scope="scope">
              <dictionary-text
                code="copter_intake_type"
                :value="scope.row.waterSourceType"
              />
            </template>
          </el-table-column>

          <el-table-column
            v-if="checkedTh.includes('waterSourceDepth')"
          ...
          <el-table-column
            v-if="checkedTh.includes('waterIntake')"
            prop="waterIntake"
            label="取水量(升/小时)"
            min-width="120"
            show-overflow-tooltip
      ...
      <!-- 这是属性框 -->
      <HelWaterIntakingEdit
        v-if="isScreenCutting"
        ref="helWaterIntakingEdit"
...
import HelWaterIntakingEditDialog from "./editDialogs/helWaterIntakingEditDialog.vue";
import HelWaterIntakingEdit from "./edits/helWaterIntakingEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_hel_water_intaking").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "水源类型", parameter: "waterSourceType" },
        { name: "水源深度(米)", parameter: "waterSourceDepth" },
        { name: "取水量(升/小时)", parameter: "waterIntake" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      helWaterIntakingApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["helWaterIntakingEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["helWaterIntakingEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      helWaterIntakingApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          helWaterIntakingApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
