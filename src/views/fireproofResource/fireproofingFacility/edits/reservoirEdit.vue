  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.heigth"
            style="width: 100%"
            placeholder="请输入高度(米)"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.heigth }}</div>
        </el-form-item>
        <el-form-item
          label="建筑面积(平方米)"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.area"
            style="width: 100%"
            placeholder="请输入建筑面积(平方米)"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.area }}</div>
        </el-form-item>
        <el-form-item
          label="设施结构类型"
          :class="[
        ...
        >
          <dictionary-select
            v-if="detailsType != '详情'"
            v-model.trim="formDetails.structureType"
            type="impound_construction_type"
            :show-code="false"
            :placeholder="'请选择设施结构类型'"
            class="filter-item"
            style="width: 100%"
          />
          <div v-else>
            <dictionary-text
              code="impound_construction_type"
              :value="formDetails.structureType"
            />
          </div>
        </el-form-item>
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.volume"
            style="width: 100%"
            placeholder="请输入容积(立方米)"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.volume }}</div>
        </el-form-item>
        <el-form-item
          label="交通情况"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.trafficCondition"
            style="width: 100%"
            placeholder="请输入交通情况"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.trafficCondition }}</div>
        </el-form-item>
        <el-form-item
          label="状态"
          :class="[
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:reservoir:update']"
          type="primary"
          class="right-btn"
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        volume: [
          { required: true, message: "请输入容积(立方米)", trigger: "blur" },
        ],
  ...
  methods: {
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        reservoirApi("detail", "get", { id: queryData.id })
          .then((res) => {
            let data = {};
