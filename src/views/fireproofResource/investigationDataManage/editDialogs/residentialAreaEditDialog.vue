        ...
        <div class="dialog-content-left" ref="dialogContentLeft">
          ...
          > 
              ...
              >
                <el-input
                  v-if="dialogtitle != '详情'"
                  v-model="formDetailsDialog.population"
                  style="width: 100%"
                  placeholder="请输入人口"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetailsDialog.population }}</div>
              </el-form-item>
              <el-form-item
                label="面积"
                :class="[
              ...
              >
                <el-input
                  v-if="dialogtitle != '详情'"
                  v-model="formDetailsDialog.acreage"
                  style="width: 100%"
                  placeholder="请输入面积"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetailsDialog.acreage }}</div>
              </el-form-item>
              <el-form-item
                label="负责人"
                :class="[
              ...
              >
                <el-input
                  v-if="dialogtitle != '详情'"
                  v-model="formDetailsDialog.refuge"
                  style="width: 100%"
                  placeholder="请输入庇护所"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetailsDialog.refuge }}</div>
              </el-form-item>
              <span />
  ...
  methods: {
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        residentialAreaApi('detail', 'get', { id: queryData.id })
          .then((res) => {
            let data = {};
    ...
    handleSubmitClick() {
      this.$refs['formDetailsDialog'].validate((valid) => {
        if (valid) {
          ...
          if (this.dialogtitle == '新增') {
            residentialAreaApi('create', 'post', this.formDetailsDialog)
              .then((res) => {
                this.$message({
                  type: 'success',
                  message: '新增成功'
            ...
            residentialAreaApi('update', 'post', data)
              .then((res) => {
                this.$message({
                  type: 'success',
                  message: '修改成功'
