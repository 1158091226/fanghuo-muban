  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:checkpoint:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:checkpoint:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:checkpoint:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:checkpoint:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:checkpoint:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:checkpoint:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:checkpoint:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:checkpoint:column-filter']"
        ...
        <div
          v-permission="['fireprot:checkpoint:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('checkArea')"
            prop="checkArea"
            label="检查区域"
            min-width="120"
            show-overflow-tooltip
...
import CheckpointEditDialog from "./editDialogs/checkpointEditDialog.vue";
import CheckpointEdit from "./edits/checkpointEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_checkpoint").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "建筑时间", parameter: "buildTime" },
        { name: "检查区域", parameter: "checkArea" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      checkpointApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["checkpointEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["checkpointEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      checkpointApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          checkpointApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
