      ...
      <div class="dialog-content-left" ref="dialogContentLeft">
        ...
        >
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.heigth"
              style="width: 100%"
              placeholder="请输入高度(米)"
              class="filter-item"
              clearable
            />
            <div v-else>{{ formDetailsDialog.heigth }}</div>
          </el-form-item>
          <el-form-item
            label="建筑面积(平方米)"
            :class="[
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.area"
              style="width: 100%"
              placeholder="请输入建筑面积(平方米)"
              class="filter-item"
              clearable
            />
            <div v-else>{{ formDetailsDialog.area }}</div>
          </el-form-item>
          <el-form-item
            label="设施结构类型"
            :class="[
          ...
          >
            <dictionary-select
              v-if="dialogtitle != '详情'"
              v-model.trim="formDetailsDialog.structureType"
            ...
            <div v-else>
              <dictionary-text
                ...
                :value="formDetailsDialog.structureType"
              />
            </div>
          </el-form-item>
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.volume"
              style="width: 100%"
              placeholder="请输入容积(立方米)"
              class="filter-item"
              clearable
            />
            <div v-else>{{ formDetailsDialog.volume }}</div>
          </el-form-item>
          <el-form-item
            label="交通情况"
            :class="[
    ...
    handleSubmitClick() {
      this.$refs["formDetailsDialog"].validate((valid) => {
        if (valid) {
          ...
          if (this.dialogtitle == "新增") {
            reservoirApi("create", "post", this.formDetailsDialog)
              .then((res) => {
                this.$message({
                  type: "success",
                  message: "新增成功",
