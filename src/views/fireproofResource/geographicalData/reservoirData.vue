  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['forestry:reservoirData:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['forestry:reservoirData:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['forestry:reservoirData:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['forestry:reservoirData:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['forestry:reservoirData:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['forestry:reservoirData:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['forestry:reservoirData:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['forestry:reservoirData:column-filter']"
        ...
        <div
          v-permission="['forestry:reservoirData:layout']"
          style="display: flex; align-items: center"
...
import { reservoirDataApi } from "@/api/forestry/reservoirData";
import ReservoirDataEditDialog from "./editDialogs/reservoirDataEditDialog.vue";
import ReservoirDataEdit from "./edits/reservoirDataEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("bgd_reservoir_data").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "名称", parameter: "name" },
        { name: "类型", parameter: "type" },
        { name: "水库面积", parameter: "area" },
      ],
    };
  },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      reservoirDataApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["reservoirDataEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["reservoirDataEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      reservoirDataApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          reservoirDataApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
