  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">宣传牌类型</div>
          <dictionary-select
            v-model.trim="query.type"
            type="fireproofing_publicity_type"
            :show-code="false"
            :placeholder="'请选择'"
            class="filter-item"
            style="flex: 1"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:billboard:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:billboard:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:billboard:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:billboard:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:billboard:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:billboard:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:billboard:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:billboard:column-filter']"
        ...
        <div
          v-permission="['fireprot:billboard:layout']"
          style="display: flex; align-items: center"
      ...
      >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <dictionary-text
                code="fireproofing_publicity_type"
          ...
          <el-table-column
            v-if="checkedTh.includes('producer')"
            prop="producer"
            label="制作单位"
            min-width="120"
            show-overflow-tooltip
          ...
          <el-table-column
            v-if="checkedTh.includes('productionTime')"
            prop="productionTime"
            label="制作时间"
            min-width="120"
            sortable="custom"
...
import BillboardEditDialog from "./editDialogs/billboardEditDialog.vue";
import BillboardEdit from "./edits/billboardEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_billboard").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "名称", parameter: "name" },
        { name: "宣传牌类型", parameter: "type" },
        { name: "制作单位", parameter: "producer" },
        { name: "制作时间", parameter: "productionTime" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      billboardApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["billboardEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["billboardEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      billboardApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          billboardApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
