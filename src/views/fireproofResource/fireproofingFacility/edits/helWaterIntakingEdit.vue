    ...
    <div class="list-details">
        ...
        <div class="details-content-box">
          ...
          >
              ...
              >
                <dictionary-select
                  v-if="detailsType != '详情'"
                  v-model.trim="formDetails.waterSourceType"
                  ...
                  style="width: 100%"
                />
                <div v-else><dictionary-text  code="copter_intake_type"  :value="formDetails.waterSourceType" /></div>
              </el-form-item>
              ...
              >
                <el-input
                  v-if="detailsType != '详情'"
                  v-model="formDetails.waterSourceDepth"
                  style="width: 100%"
                  placeholder="请输入水源深度(米)"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetails.waterSourceDepth }}</div>
              </el-form-item>
              <el-form-item
                label="交通情况"
                :class="[
              ...
              >
                <el-input
                  v-if="detailsType != '详情'"
                  v-model="formDetails.clearanceSituation"
                  style="width: 100%"
                  placeholder="请输入净空情况"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetails.clearanceSituation }}</div>
              </el-form-item>
              <el-form-item
                label="容积(立方米)"
                :class="[
              ...
              >
                <el-input
                  v-if="detailsType != '详情'"
                  v-model="formDetails.capacity"
                  style="width: 100%"
                  placeholder="请输入容积(立方米)"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetails.capacity }}</div>
              </el-form-item>
              <el-form-item
                label="取水量(升/小时)"
                :class="[
              ...
              >
                <el-input
                  v-if="detailsType != '详情'"
                  v-model="formDetails.waterIntake"
                  style="width: 100%"
                  placeholder="请输入取水量(升/小时)"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetails.waterIntake }}</div>
              </el-form-item>
              <el-form-item
                label="取水频率"
                :class="[
              ...
              >
                <el-input
                  v-if="detailsType != '详情'"
                  v-model="formDetails.waterIntakeFreq"
                  style="width: 100%"
                  placeholder="请输入取水频率"
                  class="filter-item"
                  clearable
                />
                <div v-else>{{ formDetails.waterIntakeFreq }}</div>
              </el-form-item>
              <el-form-item
                label="负责人"
                :class="[
        ...
        <div v-show="isShowHandle" class="details-btn-box">
          ...
          <div v-if="detailsType == '详情'" class="btn-right">
            ...
            <el-button
              v-permission="['fireprot:helWaterIntaking:update']"
              type="primary"
              class="right-btn"
