  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <dictionary-select
            v-if="detailsType != '详情'"
            v-model.trim="formDetails.carType"
        ...
        >
          <dictionary-select
            v-if="detailsType != '详情'"
            v-model.trim="formDetails.catStatus"
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.vehicleEquipmentDetails"
            type="textarea"
            placeholder="请输入车载设备详情"
          />
          <div v-else>{{ formDetails.vehicleEquipmentDetails }}</div>
        </el-form-item>
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:firetruck:update']"
          type="primary"
          class="right-btn"
