      ...
      <div class="dialog-content-left" ref="dialogContentLeft">
        ...
        >
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.buildAltitude"
              style="width: 100%"
              placeholder="请输入建设海拔(米)"
              class="filter-item"
              clearable
            />
            <div v-else>{{ formDetailsDialog.buildAltitude }}</div>
          </el-form-item>
          <el-form-item
            label="建设时间"
            :class="[
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.towerHeigth"
              style="width: 100%"
              placeholder="请输入塔体总高度(米)"
              class="filter-item"
              clearable
            />
            <div v-else>{{ formDetailsDialog.towerHeigth }}</div>
          </el-form-item>
          <el-form-item
            label="观测面积(亩)"
            :class="[
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.observedArea"
              style="width: 100%"
              placeholder="请输入观测面积(亩)"
              class="filter-item"
              clearable
            />
            <div v-else>{{ formDetailsDialog.observedArea }}</div>
          </el-form-item>
          <el-form-item
            label="总体有效瞭望覆盖面积(亩)"
            :class="[
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.overallEffectiveLookoutArea"
              style="width: 100%"
            ...
            />
            <div v-else>
              {{ formDetailsDialog.overallEffectiveLookoutArea }}
            </div>
          </el-form-item>
          <el-form-item
            label="装载设备"
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.loadingEquipment"
              type="textarea"
              placeholder="请输入装载设备"
            />
            <div v-else>{{ formDetailsDialog.loadingEquipment }}</div>
          </el-form-item>
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.staffing"
              type="textarea"
              placeholder="请输入人员配备情况"
            />
            <div v-else>{{ formDetailsDialog.staffing }}</div>
          </el-form-item>
          ...
          >
            <dictionary-select
              v-if="dialogtitle != '详情'"
              v-model.trim="formDetailsDialog.towerStatus"
            ...
            <div v-else>
              <dictionary-text
                ...
                :value="formDetailsDialog.towerStatus"
              />
            </div>
          </el-form-item>
          ...
          >
            <el-input
              v-if="dialogtitle != '详情'"
              v-model="formDetailsDialog.mgmtUnit"
              style="width: 100%"
              placeholder="请输入管护单位"
              class="filter-item"
              clearable
            />
            <div v-else>{{ formDetailsDialog.mgmtUnit }}</div>
          </el-form-item>
          <el-form-item
            label="负责人"
            :class="[
    ...
    handleSubmitClick() {
      this.$refs["formDetailsDialog"].validate((valid) => {
        if (valid) {
          ...
          if (this.dialogtitle == "新增") {
            watchtowerApi("create", "post", this.formDetailsDialog)
              .then((res) => {
                this.$message({
                  type: "success",
                  message: "新增成功",
