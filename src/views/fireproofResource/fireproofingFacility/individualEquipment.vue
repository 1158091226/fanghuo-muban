  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">所属单位</div>
          <el-input
            v-model.trim="query.unit"
            style="flex: 1"
            placeholder="请输入所属单位"
            class="filter-item"
            clearable
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div
              v-permission="['fireprot:individualEquipment:more']"
              class="text1"
            >
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:individualEquipment:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:individualEquipment:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:individualEquipment:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:individualEquipment:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:individualEquipment:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:individualEquipment:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:individualEquipment:column-filter']"
        ...
        <div
          v-permission="['fireprot:individualEquipment:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('userName')"
            prop="userName"
            label="使用人员"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('userTel')"
            prop="userTel"
            label="使用人员电话"
            min-width="120"
            show-overflow-tooltip
      ...
      <!-- 这是属性框 -->
      <IndividualEquipmentEdit
        v-if="isScreenCutting"
        ref="individualEquipmentEdit"
...
import IndividualEquipmentEditDialog from "./editDialogs/individualEquipmentEditDialog.vue";
import IndividualEquipmentEdit from "./edits/individualEquipmentEdit.vue";
...
const listItemDefault = {
  ...
  name: undefined,
  unit: undefined,
  deviceStorageLocation: undefined,
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_individual_equipment").showColumn,
      isIndeterminate: true,
      // 表格表头列表
      tableListTitle: [
        { name: "区划代码", parameter: "areaCode" },
        { name: "名称", parameter: "name" },
        { name: "所属单位", parameter: "unit" },
        { name: "使用人员", parameter: "userName" },
        { name: "使用人员电话", parameter: "userTel" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      individualEquipmentApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["individualEquipmentEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["individualEquipmentEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      individualEquipmentApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          individualEquipmentApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
