  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">面积(平方米)</div>
          <el-input
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['forestry:industrialData:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['forestry:industrialData:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['forestry:industrialData:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['forestry:industrialData:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['forestry:industrialData:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['forestry:industrialData:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['forestry:industrialData:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['forestry:industrialData:column-filter']"
        ...
        <div
          v-permission="['forestry:industrialData:layout']"
          style="display: flex; align-items: center"
...
import IndustrialDataEditDialog from "./editDialogs/industrialDataEditDialog.vue";
import IndustrialDataEdit from "./edits/industrialDataEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("forestry_industrial_data").showColumn,
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      industrialDataApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["industrialDataEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["industrialDataEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      industrialDataApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          industrialDataApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
