  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:helLanding:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:helLanding:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:helLanding:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:helLanding:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:helLanding:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:helLanding:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:helLanding:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:helLanding:column-filter']"
        ...
        <div
          v-permission="['fireprot:helLanding:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('trafficCondition')"
          ...
          <el-table-column
            v-if="checkedTh.includes('clearanceSituation')"
...
import HelLandingEditDialog from "./editDialogs/helLandingEditDialog.vue";
import HelLandingEdit from "./edits/helLandingEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_hel_landing").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "海拔(单位米)", parameter: "altitude" },
        { name: "交通情况", parameter: "trafficCondition" },
        { name: "净空情况", parameter: "clearanceSituation" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      helLandingApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["helLandingEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["helLandingEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      helLandingApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          helLandingApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
