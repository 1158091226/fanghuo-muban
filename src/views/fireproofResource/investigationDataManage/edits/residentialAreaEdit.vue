  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.population"
            style="width: 100%"
            placeholder="请输入人口"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.population }}</div>
        </el-form-item>
        <el-form-item
          label="面积"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.acreage"
            style="width: 100%"
            placeholder="请输入面积"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.acreage }}</div>
        </el-form-item>
        <el-form-item
          label="负责人"
          :class="[
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.refuge"
            style="width: 100%"
            placeholder="请输入庇护所"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.refuge }}</div>
        </el-form-item>
        <!--  是否是空间信息  -->
        <span />
      </el-form>
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:residentialArea:update']"
          type="primary"
          class="right-btn"
