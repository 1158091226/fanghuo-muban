  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          ...
          />
          <div v-else>
            <dictionary-text code="road_data_type" :value="formDetails.type" />
          </div>
        </el-form-item>
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['forestry:roadData:update']"
          type="primary"
          class="right-btn"
  ...
  methods: {
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        roadDataApi("detail", "get", { id: queryData.id })
          .then((res) => {
            let data = {};
