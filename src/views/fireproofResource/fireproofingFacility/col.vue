  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:col:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:col:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:col:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:col:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:col:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:col:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:col:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:col:column-filter']"
        ...
        <div
          v-permission="['fireprot:col:layout']"
          style="display: flex; align-items: center"
...
import ColEditDialog from "./editDialogs/colEditDialog.vue";
import ColEdit from "./edits/colEdit.vue";
...
const listItemDefault = {
  ...
  name: undefined,
  address: undefined,
  loadingEquipmentCondition: undefined,
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_col").showColumn,
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      colApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["colEdit"].updateDetails();
      });
    },
    ...
    downExcelClick() {
      ...
      colApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          colApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
