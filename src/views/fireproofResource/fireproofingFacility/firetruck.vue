  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">车型</div>
          <dictionary-select
            v-model.trim="query.carType"
            type="fire_truck_type"
            :show-code="false"
            :placeholder="'请选择'"
            class="filter-item"
            style="flex: 1"
        ...
        <div class="screen-box-item">
          <div class="item-text">车辆情况</div>
          <dictionary-select
            v-model.trim="query.catStatus"
            type="fire_truck_condition"
            :show-code="false"
            :placeholder="'请选择'"
            class="filter-item"
            style="flex: 1"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:firetruck:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:firetruck:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:firetruck:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:firetruck:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:firetruck:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:firetruck:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:firetruck:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:firetruck:column-filter']"
        ...
        <div
          v-permission="['fireprot:firetruck:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('carType')"
            prop="carType"
            label="车型"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('catStatus')"
            prop="catStatus"
            label="车辆情况"
            min-width="120"
            sortable="custom"
          ...
          >
            <template slot-scope="scope">
              <dictionary-text
                code="fire_truck_condition"
                :value="scope.row.catStatus"
              />
            </template>
          </el-table-column>
...
import FiretruckEditDialog from "./editDialogs/firetruckEditDialog.vue";
import FiretruckEdit from "./edits/firetruckEdit.vue";
...
const listItemDefault = {
  ...
  carType: undefined,
  catStatus: undefined,
  vehicleEquipmentDetails: undefined,
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_firetruck").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "车型", parameter: "carType" },
        { name: "车辆情况", parameter: "catStatus" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      firetruckApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["firetruckEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["firetruckEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      firetruckApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          firetruckApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
