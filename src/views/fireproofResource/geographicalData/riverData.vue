  ...
  <div class="app-list-page" v-loading="requestLoading">
    ...
    <div class="screen-box">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          <div class="item-text">河流长度</div>
          <el-input
            v-model.trim="query.length"
            style="flex: 1"
            placeholder="请输入河流长度"
            class="filter-item"
            clearable
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['forestry:riverData:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['forestry:riverData:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['forestry:riverData:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['forestry:riverData:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['forestry:riverData:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['forestry:riverData:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['forestry:riverData:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['forestry:riverData:column-filter']"
        ...
        <div
          v-permission="['forestry:riverData:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <dictionary-text code="river_data_type" :value="scope.row.type" />
            </template>
          </el-table-column>
...
import { riverDataApi } from "@/api/forestry/riverData";
import RiverDataEditDialog from "./editDialogs/riverDataEditDialog.vue";
import RiverDataEdit from "./edits/riverDataEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("bgd_river_data").showColumn,
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      riverDataApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["riverDataEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["riverDataEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      riverDataApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          riverDataApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
