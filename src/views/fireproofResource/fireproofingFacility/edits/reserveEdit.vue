  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.buildArea"
            style="width: 100%"
            placeholder="请输入建设面积(平方米)"
            class="filter-item"
            clearable
          />
          <div v-else>{{ formDetails.buildArea }}</div>
        </el-form-item>
        <el-form-item
          label="有效容量(立方米)"
          :class="[
        ...
        >
          <dictionary-select
            v-if="detailsType != '详情'"
            v-model.trim="formDetails.reserveLevel"
            type="material_reserves_level"
            :show-code="false"
            :placeholder="'请选择储备等级'"
            class="filter-item"
            style="width: 100%"
          ...
          <div v-else>
            <dictionary-text
              code="material_reserves_level"
              :value="formDetails.reserveLevel"
            />
          </div>
        </el-form-item>
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:reserve:update']"
          type="primary"
          class="right-btn"
  ...
  methods: {
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        reserveApi("detail", "get", { id: queryData.id })
          .then((res) => {
            let data = {};
