  ...
  <div class="list-details">
    ...
    <div class="details-content-box">
      ...
      >
        ...
        <el-form-item
          ...
          prop="loadingEquipmentCondition"
        >
          <el-input
            v-if="detailsType != '详情'"
            v-model="formDetails.loadingEquipmentCondition"
            type="textarea"
            placeholder="请输入装载设备情况"
          />
          <div v-else>{{ formDetails.loadingEquipmentCondition }}</div>
        </el-form-item>
    ...
    <div v-show="isShowHandle" class="details-btn-box">
      ...
      <div v-if="detailsType == '详情'" class="btn-right">
        ...
        <el-button
          v-permission="['fireprot:col:update']"
          type="primary"
          class="right-btn"
  ...
  methods: {
    ...
    getDetailsFunction(queryData, listdata) {
      return new Promise((resolve, reject) => {
        colApi("detail", "get", { id: queryData.id })
          .then((res) => {
            let data = {};
