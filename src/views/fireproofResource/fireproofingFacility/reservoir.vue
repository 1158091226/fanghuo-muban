  ...
  <div class="app-list-page" v-loading="requestLoading">
      ...
      <div class="screen-box-input">
        ...
        <div class="screen-box-item">
          ...
          <dictionary-select
            ...
            type="impound_construction_state"
            :show-code="false"
            :placeholder="'请选择'"
            class="filter-item"
            style="flex: 1"
      ...
      <div class="screen-box-button">
        <el-popover placement="bottom" width="480" trigger="click">
          ...
          <div slot="reference" style="display: flex; align-items: center">
            <div v-permission="['fireprot:reservoir:more']" class="text1">
              更多
        ...
        <el-button
          type="primary"
          class="btn"
          v-permission="['fireprot:reservoir:query']"
    ...
    <div class="operation-box">
      <div class="operation-box-left">
        <el-button
          v-permission="['fireprot:reservoir:create']"
          class="btn1"
          type="primary"
          icon="el-icon-addnew"
          plain
        ...
        >
        <el-button
          v-permission="['fireprot:reservoir:delete']"
          class="btn2"
          type="danger"
        ...
        >
        <el-button
          v-permission="['fireprot:reservoir:import']"
          class="btn3"
        ...
        >
        <el-button
          v-permission="['fireprot:reservoir:export']"
          class="btn4"
        ...
        >
        <el-button
          v-permission="['fireprot:reservoir:map-plus']"
          class="btn5"
          icon="el-icon-earth"
          plain
          >一张图</el-button
      ...
      <div class="operation-box-right">
        ...
        >
          ...
          <div
            slot="reference"
            v-permission="['fireprot:reservoir:column-filter']"
        ...
        <div
          v-permission="['fireprot:reservoir:layout']"
          style="display: flex; align-items: center"
    ...
    <div class="list-map-box" :class="[isMoveBox ? 'not-select' : '']">
      ...
      >
        ...
        >
          ...
          <el-table-column
            v-if="checkedTh.includes('heigth')"
            prop="heigth"
            label="高度(米)"
            min-width="120"
            sortable="custom"
          ...
          <el-table-column
            v-if="checkedTh.includes('volume')"
            prop="volume"
            label="容积(立方米)"
            min-width="120"
            show-overflow-tooltip
          ...
          >
            <template slot-scope="scope">
              <dictionary-text
                code="impound_construction_state"
...
import ReservoirEditDialog from "./editDialogs/reservoirEditDialog.vue";
import ReservoirEdit from "./edits/reservoirEdit.vue";
...
export default {
  ...
  data() {
    return {
      ...
      checkAll: false,
      checkedTh: fireproofDict("fireprot_reservoir").showColumn,
      ...
      tableListTitle: [
        ...
        { name: "海拔(米)", parameter: "buildAltitude" },
        { name: "长度(米)", parameter: "length" },
        { name: "宽度(米)", parameter: "width" },
        { name: "高度(米)", parameter: "heigth" },
        { name: "建筑面积(平方米)", parameter: "area" },
        { name: "容积(立方米)", parameter: "volume" },
  ...
  methods: {
    ...
    // 列表数据查询
    getList() {
      reservoirApi("page", "post", this.queryData)
        .then((res) => {
    ...
    async handleMoveSelectClick(type) {
      ...
      this.$nextTick(() => {
        this.$refs["reservoirEdit"].updateDetails();
      });
    },
    ...
    async tableCurrentChange(currentRow) {
      ...
      if (this.isScreenCutting) {
        ...
        this.$nextTick(() => {
          this.$refs["reservoirEdit"].initDetails();
        });
      }
    },
    ...
    downExcelClick() {
      ...
      reservoirApi("export_all/excel", "post", data).then((res) => {
    ...
    getDeleteFunction(data) {
      ...
      this.$confirm("确定删除？", "提示", {
        ...
        .then(() => {
          reservoirApi("delete", "post", ids).then((res) => {
            this.$message({
              type: "success",
              message: "删除成功",
            });
